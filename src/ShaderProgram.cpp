...
void ShaderProgram::set_uniform(GLuint ID, const int *val, GLsizei count) const {
    glUniform1iv(ID, count, val);
}

void ShaderProgram::set_uniform(GLuint ID, const float *val, GLsizei count) const {
    glUniform1fv(ID, count, val);
}

void ShaderProgram::set_uniform(GLuint ID, const glm::vec2 *val, GLsizei count) const {
    glUniform2fv(ID, count, &val[0][0]);
}

void ShaderProgram::set_uniform(GLuint ID, const glm::vec3 *val, GLsizei count) const {
    glUniform3fv(ID, count, &val[0][0]);
}

void ShaderProgram::set_uniform(GLuint ID, const glm::vec4 *val, GLsizei count) const {
    glUniform4fv(ID, count, &val[0][0]);
}

void ShaderProgram::set_uniform(GLuint ID, const glm::mat4 *val, GLsizei count) const {
